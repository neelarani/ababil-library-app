...
const features = [
  ...
  {
    icon: <Wallet className="w-8 h-8 text-destructive" />,
    title: 'Smart Wallet',
    description:
      'Manage your balance, add funds, and withdraw instantly with ease.',
  },
  {
    icon: <Send className="w-8 h-8 text-sidebar-primary" />,
    title: 'Instant Transfers',
    description:
      'Send and receive money in seconds — no hidden delays or fees.',
  },
  {
    icon: <Globe className="w-8 h-8 text-chart-4" />,
    ...
    <section className="py-20">
      <div className="max-w-6xl mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-4">
          Why Choose <span className="text-primary">Ababil Wallet </span>?
        </h2>
